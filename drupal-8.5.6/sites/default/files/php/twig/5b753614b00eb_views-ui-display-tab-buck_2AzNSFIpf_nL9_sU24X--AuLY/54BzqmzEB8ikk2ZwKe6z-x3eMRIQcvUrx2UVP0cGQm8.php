...
(isset($context["overridden"]) ? $context["overridden"] : null)) ? ("overridden") : ("")));
  ...
  ";
        ...
        if ((isset($context["actions"]) ? $context["actions"] : null)) {
            // line 30
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["actions"]) ? $context["actions"] : null), "html", null, true));
        }
        // line 32
        echo "  ";
...
";
    ...
    {
        return new Twig_Source("", "core/themes/stable/templates/admin/views-ui-display-tab-bucket.html.twig", "/var/www/html/RND/RobinSingh/drupal-8.5.6/core/themes/stable/templates/admin/views-ui-display-tab-bucket.html.twig");
    }
}
