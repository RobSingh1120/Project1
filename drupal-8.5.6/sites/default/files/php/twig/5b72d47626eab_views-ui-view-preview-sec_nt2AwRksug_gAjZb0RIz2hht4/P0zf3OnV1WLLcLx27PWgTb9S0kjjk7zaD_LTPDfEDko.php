...
";
        ...
        if ((isset($context["links"]) ? $context["links"] : null)) {
            ...
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["links"]) ? $context["links"] : null), "html", null, true));
            echo "</div>
";
        }
        // line 18
...
";
    ...
    {
        return new Twig_Source("", "core/themes/stable/templates/admin/views-ui-view-preview-section.html.twig", "/var/www/html/RND/RobinSingh/drupal-8.5.6/core/themes/stable/templates/admin/views-ui-view-preview-section.html.twig");
    }
}
