...
(isset($context["overridden"]) ? $context["overridden"] : null)) ? ("overridden") : ("")));
  ...
  ";
        ...
        if ((isset($context["settings_links"]) ? $context["settings_links"] : null)) {
            // line 33
            echo "    ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\Core\Template\TwigExtension')->safeJoin($this->env, (isset($context["settings_links"]) ? $context["settings_links"] : null), "<span class=\"label\">&nbsp;|&nbsp;</span>")));
            echo "
  ";
        }
        // line 35
...
";
    ...
    {
        return new Twig_Source("", "core/themes/stable/templates/admin/views-ui-display-tab-setting.html.twig", "/var/www/html/RND/RobinSingh/drupal-8.5.6/core/themes/stable/templates/admin/views-ui-display-tab-setting.html.twig");
    }
}
